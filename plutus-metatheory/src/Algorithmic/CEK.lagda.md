...
BUILTIN integerToByteString (base $ V-con i) with ITOBS i
... | nothing = inj₁ (con (ne (^ (atomic aBytestring))))
... | just b = inj₂ (V-con b)
BUILTIN byteStringToInteger (base $ V-con b) = inj₂ (V-con (BSTOI b))
BUILTIN andByteString (base $ V-con b $ V-con b') with (andBS b b')
... | nothing = inj₁ (con (ne (^ (atomic aBytestring))))
... | just b = inj₂ (V-con b)
BUILTIN iorByteString (base $ V-con b $ V-con b') with (iorBS b b')
... | nothing = inj₁ (con (ne (^ (atomic aBytestring))))
... | just b = inj₂ (V-con b)
BUILTIN xorByteString (base $ V-con b $ V-con b') with (xorBS b b')
... | nothing = inj₁ (con (ne (^ (atomic aBytestring))))
... | just b = inj₂ (V-con b)
BUILTIN complementByteString (base $ V-con b) = inj₂ (V-con (complementBS b))
BUILTIN shiftByteString (base $ V-con b $ V-con i) = inj₂ (V-con (shiftBS b i))
BUILTIN rotateByteString (base $ V-con b $ V-con i) = inj₂ (V-con (rotateBS b i))
BUILTIN popCountByteString (base $ V-con b) = inj₂ (V-con (popCountBS b))
BUILTIN testBitByteString (base $ V-con b $ V-con i) with (testBitBS b i)
... | nothing = inj₁ (con (ne (^ (atomic aBool))))
... | just b = inj₂ (V-con b)
BUILTIN writeBitByteString (base $ V-con b $ V-con i $ V-con v) with (writeBitBS b i v)
... | nothing = inj₁ (con (ne (^ (atomic aBytestring))))
... | just b = inj₂ (V-con b)
BUILTIN findFirstSetByteString (base $ V-con b) = inj₂ (V-con (findFirstSetBS b))
