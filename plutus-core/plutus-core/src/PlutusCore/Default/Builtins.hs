...
instance uni ~ DefaultUni => ToBuiltinMeaning uni DefaultFun where
    ...
    toBuiltinMeaning _semvar IorByteString =
        makeBuiltinMeaning
            iorByteString
    ...
    toBuiltinMeaning _semvar PopCountByteString =
        makeBuiltinMeaning
            popCountByteString
            (runCostingFunOneArgument . paramPopCountByteString)
    toBuiltinMeaning _semvar TestBitByteString =
        makeBuiltinMeaning
            testBitByteString
            (runCostingFunTwoArguments . paramTestBitByteString)
    toBuiltinMeaning _semvar WriteBitByteString =
        makeBuiltinMeaning
            writeBitByteString
            (runCostingFunThreeArguments . paramWriteBitByteString)
    toBuiltinMeaning _semvar FindFirstSetByteString =
        makeBuiltinMeaning
            findFirstSetByteString
